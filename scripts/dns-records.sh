...
#   _ans.<host>        TXT   v=ans1; version=v<ver>; p=a2a; mode=direct; url=https://<host>
...
#   <host>             HTTPS 1 . alpn=h2            (the RA asks for this one)
#   <host>             SVCB  1 . alpn=a2a,h2        (optional, Overpass discovery)
