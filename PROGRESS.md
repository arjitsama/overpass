...
| 11 | Deploy, demo, submission | ✅ done, tag `v1.0` | [plan](docs/plans/phase-11.md) | [status](docs/status/phase-11.md) |

## Where things stand
- Phases 0–11 are shipped: an agent binary (`--role ops|authority|station|auditor|spacecraft`),
